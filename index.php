...
<body>
    ...
    <section id="banner" class="section-m1">
        ...
        <h2>Up to <span>70% Off</span> - All Flowers in Boquet Arrangement</h2>
    ...
    <section id="sm-banner" class="section-p1">
        <div class="banner-box">
            ...
            <span>The best classic flowers</span>
            <button class="white">Learn more</button>
        </div>
        <div class="banner-box">
            <h4>spring/summer</h4>
            <h2>upcoming season</h2>
            <span>The best classic flowers is on sale</span>
