...
<section id="header">
    ...
    <section id="about-head" class="section-p1">
        ...
        <div>
            <h2>Who We Are?</h2>
            <p>Yumna's Journal is an online flower shop dedicated to spreading joy through beautifully crafted bouquets. 
                Our fully responsive website offers a seamless shopping experience with dynamic product catalogs, customizable arrangements, 
                and a helpful Wiki for site care tips. We source fresh, eco-friendly blooms from local growers, ensuring quality and sustainability. 
                With multiple themes, personalized designs, and charming packaging, every order feels extra special. Whether celebrating a milestone or 
                brightening an ordinary day, Yumna's Journal makes sending flowers effortless and delightful. Let's bring a little more beauty into the 
                world—one bouquet at a time! 🌸✨
            </p>
    ...
    <section id="about-app" class="section-p1">
        <h1>How we create <a href=shop.php>bouquets!</a></h1>
        <div class="video">
    ...
    <section id="flower-quote" class="section-p1">
        <h2>Select a Flower to Get a Quote</h2>
        <div class="quote-container">
            <label for="flowerSelect">Choose a flower:</label>
